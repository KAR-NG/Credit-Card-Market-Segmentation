...
The dataset contain 8950 rows and 17 variables. The "dbl" and "ind" are data type allocated by R to a particular column. The "dbl" stands for "double", it is used for numerical variables that have decimal places. The "int" stands for integer, it is used for numerical variables that have integer values. 
